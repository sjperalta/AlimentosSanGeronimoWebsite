      ...
      <section className="relative min-h-screen flex items-center px-8 py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <motion.img
            ...
            src={`${import.meta.env.BASE_URL}images/ginger-hero.png`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="aspect-square rounded-3xl overflow-hidden border-8 border-white/10 backdrop-blur-3xl shadow-2xl">
                <img className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700" src={`${import.meta.env.BASE_URL}images/ginger_alternative.png`} alt="Calidad San Geronimo" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-center gap-20">
          ...
          >
            <div className="aspect-square rounded-xl overflow-hidden shadow-2xl">
              <img className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" src={`${import.meta.env.BASE_URL}images/pompilio-real.png`} alt="Pompilio Sagastume - Legacy" />
            </div>
            <motion.div
